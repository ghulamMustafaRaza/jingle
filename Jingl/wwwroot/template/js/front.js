...
$(document).ready(function () {
    ...
    //        $('#Discover').attr('src', '/template/img/ic-discover-active.png');
    ...
    //    $('.ul-header li a').on('click', function () {
    //        $('.ul-header li').find('a.active').removeClass('active');
    ...
    $('#Search').on({
        'click': function () {
            $('.box-search').toggleClass('search-visible');
        }
    })
})
...
$(function () {
    ...
    body.on('keyup', '.otp-num', goToNextInput);
    body.on('keydown', '.otp-num', onKeyDown);
    body.on('click', '.otp-num', onFocus);
...
var handlePieAndDonutChart = function () {
    ...
    var pieChartData = [
        { 'label': 'Travel', 'value': 14, 'color': COLOR_PURPLE },
        { 'label': 'Food & Beverages', 'value': 36, 'color': COLOR_RED },
        { 'label': 'Beauty', 'value': 50, 'color': COLOR_BLUE }
    ];
