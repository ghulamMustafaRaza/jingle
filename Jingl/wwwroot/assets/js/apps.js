...
var handleSidebarMenu = function() {
    ...
    $('.sidebar .nav > .has-sub > a').click(function () {
        ...
        if ($('.page-sidebar-minified').length === 0) {
            ...
            $(otherMenu).closest('li').removeClass('currentPage');
                ...
                if (!$(target).is(':visible')) {
                    ...
                    $("li.has-sub").each(function (index, item) {
                        if ($(item).hasClass('expand')) {
                            ...
                            localStorage.setItem("Open", index);
                        }
                    });
  ...
  //  });
    ...
    //    var previouslyOpenItems = $.cookie('open_items');
    //    var openItemIndexes = previouslyOpenItems.split(',');
    //    console.log(openItemIndexes);
